...
CustomerCurated_node1693745022656 = glueContext.create_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://dung4476-cd0030bucket-customers/customer/curated/"], "recurse": True},
...
StepTrainerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://dung4476-cd0030bucket-step-trainer/landing/"],
        "recurse": True,
    },
...
StepTrainerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://dung4476-cd0030bucket-step-trainer/trusted/",
        "compression": "snappy",
        "partitionKeys": [],
    },
